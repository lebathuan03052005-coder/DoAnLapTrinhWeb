...
const [activeLocation, setActiveLocation] = useState("");
  ...
  const featuredHotels = [
    ...hotelsData.filter(h => h.city === "Vũng Tàu" && h.stars === 5).slice(0, 2),
    ...hotelsData.filter(h => h.city === "Đà Lạt" && h.stars === 5).slice(0, 2),
  ];
  ...
  return (
    <div className="homepage-wrapper">
      ...
      <div className="agoda-hero">
        ...
        <div className="hero-greeting">
          ...
          <p className="greeting-sub">Trân trọng được chào đón những hành khách iu quý </p>
        </div>
    ...
    : "Thêm khách"}
            ...
            {showGuestPicker && (
              <div className="guest-dropdown-panel" onClick={(e) => e.stopPropagation()}>
                <div className="counter-row">
                  <div><b>Người lớn</b><p>Từ 18 tuổi trở lên</p></div>
                  <div>
                ...
                <div className="counter-row">
                  <div><b>Trẻ em</b><p>Từ 0 – 17 tuổi</p></div>
                  <div>
                ...
                <div className="counter-row">
                  <div><b>Phòng</b><p>Số lượng phòng</p></div>
                  <div>
      ...
      <div className="promo-section">
        ...
        <p className="promo-subtitle">Chính sách ưu đãi tại Vietnam Booking lên đến 60% tiền phòng</p>
        <div className="promo-grid">
          {hotelsData.filter(h => h.discount).slice(0, 3).map((h) => (
            <div
            ...
            >
              ...
              <div className="promo-info">
                ...
                <div className="promo-price-row">
                  <span className="promo-new-price">{h.price?.toLocaleString("vi-VN")} VND</span>
                  <span className="promo-old-price">
                    {Math.round(h.price / (1 - h.discount / 100)).toLocaleString("vi-VN")} VND
                  </span>
                </div>
              </div>
            </div>
