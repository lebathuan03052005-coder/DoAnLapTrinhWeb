...
const HotelDetail = () => {
  ...
  const prevImage = (e) => {
    ...
    setCurrentImageIndex((prev) =>
      prev === 0 ? hotelGalleryData.length - 1 : prev - 1,
    );
  };
    ...
    <div className="vnbk-main-content">
      ...
      <div className="hotel-amenities-section">
        ...
        <div className="amenities-grid">
          <div className="amenity-item">
            <i className="fa-solid fa-water-ladder"></i> Hồ bơi ngoài trời
            (quanh năm)
          </div>
          <div className="amenity-item">
            <i className="fa-solid fa-dumbbell"></i> Trung tâm thể dục
          </div>
          <div className="amenity-item">
            <i className="fa-solid fa-spa"></i> Khu vực thư giãn/spa lounge
          </div>
          <div className="amenity-item">
            <i className="fa-solid fa-utensils"></i> Nhà hàng
          </div>
          <div className="amenity-item">
            <i className="fa-solid fa-martini-glass-citrus"></i> Quầy bar
          </div>
          <div className="amenity-item">
            <i className="fa-solid fa-wifi"></i> Wifi
          </div>
          <div className="amenity-item">
            <i className="fa-solid fa-snowflake"></i> Máy lạnh
          </div>
          <div className="amenity-item">
            <i className="fa-solid fa-ban-smoking"></i> Phòng không hút thuốc
          </div>
        </div>
        ...
        <div className="detailed-amenities">
          <div className="amenity-group">
            ...
            <div className="group-content grid-3">
              <div className="amenity-item">
                <i className="fa-solid fa-wind"></i> Máy lạnh
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-elevator"></i> Thang máy
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-users"></i> Phòng gia đình
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-coffee"></i> Cà phê/Trà tại sảnh
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-scissors"></i> Tiệm làm đẹp
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-wifi"></i> Wifi
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-ban-smoking"></i> Phòng không hút
                thuốc
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-concierge-bell"></i> Dịch vụ phòng
              </div>
            </div>
          </div>
          ...
          <div className="amenity-group">
            ...
            <div className="group-content grid-3">
              ...
              <div className="amenity-item">
                <i className="fa-solid fa-shower"></i> Phòng tắm vòi sen
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-tv"></i> TV
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-shirt"></i> Áo choàng tắm
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-fan"></i> Điều hòa
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-wine-glass"></i> Tủ lạnh nhỏ trong
                phòng
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-wind"></i> Máy sấy tóc
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-bottle-water"></i> Nước đóng chai miễn
                phí
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-vault"></i> Két sắt
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-socks"></i> Dép đi trong nhà
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-bell"></i> Dịch vụ báo thức
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-phone"></i> Điện thoại
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-clock"></i> Đồng hồ báo thức
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-couch"></i> Ghế sofa
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-rug"></i> Giá treo quần áo
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-mug-hot"></i> Máy pha trà/cà phê
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-satellite-dish"></i> Truyền hình
                cáp/vệ tinh
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-closet"></i> Tủ quần áo
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-soap"></i> Vật dụng tắm rửa
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-hand-sparkles"></i> Bộ vệ sinh cá nhân
              </div>
            </div>
          </div>
          ...
          <div className="amenity-group">
            ...
            <div className="group-content grid-3">
              <div className="amenity-item">
                <i className="fa-solid fa-wheelchair"></i> Thuận tiện cho người
                khuyết tật
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-wheelchair-move"></i> Phù hợp cho xe
                lăn
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-elevator"></i> Thang máy
          ...
          <div className="amenity-group">
            ...
            <div className="group-content grid-3">
              ...
              <div className="amenity-item">
                <i className="fa-solid fa-glass-cheers"></i> Quầy bar
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-bottle-water"></i> Nước suối
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-wine-bottle"></i> Rượu vang/Sâm panh
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-hot-tub"></i> Bữa sáng tại phòng
              </div>
            </div>
          </div>
          ...
          <div className="amenity-group">
            ...
            <div className="group-content grid-3">
              <div className="amenity-item">
                <i className="fa-solid fa-user-tie"></i> Nhân viên xách hành lý
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-door-open"></i> Nhận phòng sớm
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-suitcase-rolling"></i> Giữ hành lý
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-shield-halved"></i> Bảo vệ 24h
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-key"></i> Lễ tân 24h
              </div>
            </div>
          </div>
          ...
          <div className="amenity-group">
            ...
            <div className="group-content">
              <div className="amenity-item">
                <i className="fa-solid fa-wifi"></i> Wifi miễn phí có ở toàn bộ
                khách sạn
              </div>
            </div>
          </div>
          ...
          <div className="amenity-group">
            ...
            <div className="group-content grid-3">
              <div className="amenity-item">
                <i className="fa-solid fa-broom"></i> Dọn phòng hàng ngày
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-soap"></i> Giặt ủi
              </div>
            </div>
          </div>
          ...
          <div className="amenity-group">
            ...
            <div className="group-content grid-3">
              ...
              <div className="amenity-item">
                <i className="fa-solid fa-dumbbell"></i> Phòng gym
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-hot-tub-person"></i> Khu vực thư
                giãn/spa lounge
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-temperature-high"></i> Phòng xông hơi
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-spa"></i> Mát-xa chân
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-umbrella-beach"></i> Khăn hồ bơi/bãi
                biển
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-water-ladder"></i> Hồ bơi ngoài trời
              ...
              <div className="amenity-item">
                <i className="fa-solid fa-hands-holding-child"></i> Massage
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-heart-pulse"></i> Trung tâm Spa & chăm
                sóc sức khỏe
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-tv"></i> Truyền hình cáp/vệ tinh
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-desktop"></i> TV
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-leaf"></i> Tiện Nghi Spa
              </div>
              <div className="amenity-item">
                <i className="fa-solid fa-weight-hanging"></i> Trung tâm thể dục
              </div>
            </div>
          </div>
          ...
          <div className="amenity-group">
            ...
            <div className="group-content">
              <div className="amenity-item">
                <i className="fa-solid fa-sun"></i> Ban công/sân hiên
              </div>
            </div>
          </div>
              ...
              <div className="room-card-body">
                <div className="room-info-col">
                  ...
                  <div className="room-specs">
                    ...
                    <p>
                      <i className="fa-solid fa-bed"></i> {room.bed_type}
                    </p>
                    <p>
                      <i className="fa-solid fa-eye"></i> {room.view_type}
                    </p>
                    {room.has_bathtub && (
                      <p>
                        <i className="fa-solid fa-bath"></i> Có bồn tắm
                      </p>
                    )}
        ...
        <div className="policy-list">
          <div className="accordion-box">
            ...
            >
              ...
              <i
                className={`fa-solid ${isTimeOpen ? "fa-chevron-up" : "fa-chevron-down"}`}
              ></i>
            </div>
            {isTimeOpen && (
          ...
          <div className="accordion-box">
            ...
            >
              ...
              <i
                className={`fa-solid ${isNoteOpen ? "fa-chevron-up" : "fa-chevron-down"}`}
              ></i>
            </div>
            {isNoteOpen && (
              <div className="accordion-body">
                <p>
                  - Quý khách vui lòng xuất trình giấy tờ tùy thân khi nhận
                  phòng.
                </p>
              </div>
            )}
          ...
          <div className="accordion-box">
            ...
            >
              ...
              <i
                className={`fa-solid ${isMapOpen ? "fa-chevron-up" : "fa-chevron-down"}`}
              ></i>
            </div>
            {isMapOpen && (
              <div className="accordion-body">
      ...
      <div className="accordion-box">
        ...
        >
          ...
          <i
            className={`fa-solid ${isImportantInfoOpen ? "fa-chevron-up" : "fa-chevron-down"}`}
          ></i>
        </div>
        {isImportantInfoOpen && (
          <div className="accordion-body">
            <div className="info-row">
              ...
              <div className="info-value">
                ...
                <p>
                  • Khách từ 12 tuổi trở lên: Tính phí như người lớn, phải sử
                  dụng giường phụ.
                </p>
                <p className="note-italic">
                  * Phí giường phụ sẽ được thu trực tiếp tại khách sạn.
                </p>
              </div>
            </div>
      ...
      <div className="accordion-box">
        ...
        >
          ...
          <i
            className={`fa-solid ${isCancelOpen ? "fa-chevron-up" : "fa-chevron-down"}`}
          ></i>
        </div>
        {isCancelOpen && (
          <div className="accordion-body">
            <div className="cancel-policy-group">
              ...
              <p>
                - 07 ngày đến trước 03 ngày trước khi khách đến: 50% tổng tiền
                phòng
              </p>
              <p>
                - Trong vòng 03 ngày trước khi khách đến: 100% tổng tiền phòng
              </p>
            </div>
            ...
            <div className="cancel-policy-group">
              ...
              <p>
                - 14 ngày đến trước 07 ngày trước khi khách đến: 50% tổng tiền
                phòng
              </p>
              <p>
                - Trong vòng 07 ngày trước khi khách đến: 100% tổng tiền phòng
              </p>
            </div>
            ...
            <div className="cancel-policy-group">
              ...
              <p>
                - 30 ngày đến trước 14 ngày trước khi khách đến: 50% tổng tiền
                phòng
              </p>
              <p>
                - Trong vòng 14 ngày trước khi khách đến: 100% tổng tiền phòng
              </p>
            </div>
          </div>
        )}
      ...
      <div className="hotel-intro-section">
        ...
        <div className="intro-text-container">
          <p>
            ...
            vời cho gia đình và cặp đôi trong những kỳ nghỉ dài.
          </p>

          <p
            className={isIntroExpanded ? "intro-text-full" : "intro-text-clamp"}
          >
            Hệ thống phòng nghỉ tại đây được thiết kế tinh tế, trang bị đầy đủ
            tiện nghi từ máy lạnh, truyền hình cáp đến bồn tắm riêng biệt, giúp
            quý khách tận hưởng sự thoải mái tối đa. Đặc biệt, nhà hàng trong
            khuôn viên phục vụ đa dạng các món ẩm thực đặc sắc từ địa phương đến
            quốc tế, được chế biến bởi những đầu bếp giàu kinh nghiệm. Quý khách
            cũng có thể thư giãn tại hồ bơi ngoài trời hoặc trải nghiệm các dịch
            vụ chăm sóc sức khỏe chuyên nghiệp tại khu vực Spa. Với đội ngũ nhân
            viên lễ tân trực 24h luôn sẵn sàng hỗ trợ, chúng tôi cam kết mang
            lại cho bạn một kỳ nghỉ đáng nhớ và trọn vẹn nhất.
          </p>
      ...
      >
        <img
          src="https://cdn-icons-png.flaticon.com/512/784/784844.png"
          alt="Back to top"
        />
      ...
      {isGalleryOpen && (
        <div
          className="vnbk-gallery-overlay"
          onClick={() => setIsGalleryOpen(false)}
        >
          <div
            className="vnbk-gallery-content"
            onClick={(e) => e.stopPropagation()}
          >
            <button
              className="vnbk-close-gallery"
              onClick={() => setIsGalleryOpen(false)}
            >
            ...
            <div className="vnbk-main-image-viewport">
              ...
              <div className="vnbk-overlay-text-bottom">
                <span className="vnbk-img-label">
                  {currentMainImage?.category}
                </span>
                <span className="vnbk-img-count">
                  {currentImageIndex + 1} / {hotelGalleryData.length}
                </span>
              </div>
